...
abyssal_stalker_dance_of_darkness_evade = abyssal_stalker_dance_of_darkness_evade or class({
    ...
    GetTexture = function(self) return abyssal_stalker_dance_of_darkness:GetAbilityTextureName()  end,
})
...
function abyssal_stalker_dance_of_darkness_evade:GetModifierEvasion_Constant() return self:GetSpecialValueFor("evasion") end
function abyssal_stalker_dance_of_darkness_evade:OnAttackFail(event)
	local caster = self:GetCaster()
	if not IsServer() then return end
	if not event.target == caster then return end
...
abyssal_stalker_shadow_rush_instance = abyssal_stalker_shadow_rush_instance or class({
	IsDebuff = function(self) return false end,
    IsHidden = function(self) return false end,
    IsPurgable = function(self) return false end,
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_shadow_rush:GetAbilityTextureName()  end,
})

function abyssal_stalker_shadow_rush_instance:OnCreated()
	if not IsServer() then return end
	self:StartIntervalThink(0.1)
end

function abyssal_stalker_shadow_rush_instance:OnIntervalThink()
	if not IsServer() then return end
	if self:GetStackCount() > 0 then
		local scale = self:GetAbility():GetSpecialValueFor("damage") / 100
		local damage = Units:GetAttackDamage(self:GetCaster()) * scale
		local damageTable = {}
		damageTable.caster = self:GetCaster()
		damageTable.target = self:GetAbility().target
...
LinkedModifiers["abyssal_stalker_shadow_rush_instance"] = LUA_MODIFIER_MOTION_NONE
...
function abyssal_stalker_shadow_rush:OnSpellStart()
	...
	local blink = ParticleManager:CreateParticle("particles/units/heroes/hero_phantom_assassin/phantom_assassin_phantom_strike_start.vpcf", PATTACH_ABSORIGIN, caster)
	...
	modifierTable.caster = caster
	modifierTable.target = caster
	modifierTable.modifier_name = "abyssal_stalker_shadow_rush_instance"
	modifierTable.duration = -1
	modifierTable.stacks = self:GetSpecialValueFor("instance")
	modifierTable.max_stacks = self:GetSpecialValueFor("instance")
...
abyssal_stalker_blade_of_abyss_crit = abyssal_stalker_blade_of_abyss_crit or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_blade_of_abyss:GetAbilityTextureName()  end,
})

function abyssal_stalker_blade_of_abyss_crit:DeclareFunctions() return {MODIFIER_EVENT_ON_ATTACK_START, MODIFIER_EVENT_ON_ATTACK_LANDED} end
...
abyssal_stalker_void_dust_buff = abyssal_stalker_void_dust_buff or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_void_dust:GetAbilityTextureName()  end,
})

function abyssal_stalker_void_dust_buff:GetFireProtectionBonus() return self:GetAbility().protection end
function abyssal_stalker_void_dust_buff:GetFrostProtectionBonus() return self:GetAbility().protection end
function abyssal_stalker_void_dust_buff:GetEarthProtectionBonus() return self:GetAbility().protection end
function abyssal_stalker_void_dust_buff:GetVoidProtectionBonus() return self:GetAbility().protection end
function abyssal_stalker_void_dust_buff:GetHolyProtectionBonus() return self:GetAbility().protection end
function abyssal_stalker_void_dust_buff:GetNatureProtectionBonus() return self:GetAbility().protection end
function abyssal_stalker_void_dust_buff:GetInfernoProtectionBonus() return self:GetAbility().protection end
...
abyssal_stalker_gaze_of_abyss_effect = abyssal_stalker_gaze_of_abyss_effect or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_gaze_of_abyss:GetAbilityTextureName() end,
})
...
function abyssal_stalker_gaze_of_abyss_effect:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
...
function abyssal_stalker_gaze_of_abyss_buff:GetCriticalDamageBonus() return self:GetAbility():GetSpecialValueFor("bonus_crit_damage") end
function abyssal_stalker_gaze_of_abyss_buff:GetAttackDamagePercentBonus() return self:GetAbility():GetSpecialValueFor("bonus_damage") end
...
abyssal_stalker_rend_thinker = abyssal_stalker_rend_thinker or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_rend:GetAbilityTextureName()  end,
})
...
function abyssal_stalker_rend_thinker:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
...
abyssal_stalker_toxify_thinker = abyssal_stalker_toxify_thinker or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_toxify:GetAbilityTextureName()  end,
})
...
function abyssal_stalker_toxify_thinker:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
...
abyssal_stalker_overload_aura = abyssal_stalker_overload_aura or class({
	...
	GetModifierAura = function(self) return "abyssal_stalker_overload_effect" end,
	IsPurgable = function(self) return false end,
	IsHidden = function(self) return false end,
	IsDebuff = function(self) return false end,
	AllowIllusionDuplicate = function(self) return false end,
	RemoveOnDeath = function(self) return false end,
	GetTexture = function(self) return abyssal_stalker_overload:GetAbilityTextureName()  end,
})
...
function abyssal_stalker_overload_effect:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
function abyssal_stalker_overload_effect:GetFireProtectionBonus() return -0.3 end
function abyssal_stalker_overload_effect:GetFrostProtectionBonus() return -0.3 end
function abyssal_stalker_overload_effect:GetEarthProtectionBonus() return -0.3 end
function abyssal_stalker_overload_effect:GetHolyProtectionBonus() return -0.3 end
function abyssal_stalker_overload_effect:GetVoidProtectionBonus() return -0.3 end
function abyssal_stalker_overload_effect:GetInfernoProtectionBonus() return -0.3 end
function abyssal_stalker_overload_effect:GetNatureProtectionBonus() return -0.3 end
...
abyssal_stalker_frigid_form_aura = abyssal_stalker_frigid_form_aura or class({
	...
	GetAuraSearchTeam = function(self) return DOTA_UNIT_TARGET_TEAM_ENEMY end,
	GetAuraSearchType = function(self) return DOTA_UNIT_TARGET_HERO + DOTA_UNIT_TARGET_BASIC end,
	GetModifierAura = function(self) return "abyssal_stalker_frigid_form_effect" end,
	IsPurgable = function(self) return false end,
	IsHidden = function(self) return false end,
	IsDebuff = function(self) return false end,
	AllowIllusionDuplicate = function(self) return false end,
	RemoveOnDeath = function(self) return false end,
	GetTexture = function(self) return abyssal_stalker_frigid_form:GetAbilityTextureName()  end,
})
...
function abyssal_stalker_frigid_form_effect:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
function abyssal_stalker_frigid_form_effect:GetAttackSpeedBonus() return -100 end
function abyssal_stalker_frigid_form_effect:GetMoveSpeedBonus() return -100 end
...
abyssal_stalker_silent_strike_effect = abyssal_stalker_silent_strike_effect or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_silent_strike:GetAbilityTextureName() end,
})
...
function abyssal_stalker_silent_strike_effect:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
...
function abyssal_stalker_silent_strike_blind:DeclareFunctions() return {MODIFIER_PROPERTY_MISS_PERCENTAGE} end
function abyssal_stalker_silent_strike_blind:GetModifierMiss_Percentage() return 100 end
...
abyssal_stalker_impale_effect = abyssal_stalker_impale_effect or class({
    ...
    RemoveOnDeath = function(self) return true end,
    AllowIllusionDuplicate = function(self) return false end,
    GetTexture = function(self) return abyssal_stalker_impale:GetAbilityTextureName() end,
})
...
function abyssal_stalker_impale_effect:DeclareFunctions() return {MODIFIER_EVENT_ON_TAKEDAMAGE} end
...
function abyssal_stalker_impale_maim:DeclareFunctions() return {MODIFIER_EVENT_ON_ORDER} end
