...
function GameMode:_InitGameMode()
  ...
  if USE_AUTOMATIC_PLAYERS_PER_TEAM then
    local num = math.floor(5 / MAX_NUMBER_OF_TEAMS)
    local count = 0
  ...
  Convars:RegisterConvar('barebones_spew', tostring(spew), 'Set to 1 to start spewing barebones debug info.  Set to 0 to disable.', 1)
