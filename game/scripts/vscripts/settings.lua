...
AUTO_LAUNCH_DELAY = 99999                  -- How long should the default team selection launch timer be?  The default for custom games is 30.  Setting to 0 will skip team selection.
...
USE_AUTOMATIC_PLAYERS_PER_TEAM = false   -- Should we set the number of players to 5 / MAX_NUMBER_OF_TEAMS?
