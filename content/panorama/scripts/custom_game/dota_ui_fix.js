...
(function() {
    ...
    minimapPanel.style.border = "1px solid #ffffff09";
    minimapPanel.style.borderRadius = "0px";
    ...
    minimapPanel.style.boxShadow = "0px 0px 16px #000000aa";
    var minimap = base.FindChildTraverse('minimap');
    minimap.style.width = "250px";
    minimap.style.height = "250px";
    minimap.style.borderRadius = "0px";
